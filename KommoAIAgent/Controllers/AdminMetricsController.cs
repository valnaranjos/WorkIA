...
public sealed class AdminMetricsController : ControllerBase
{
    ...
    public async Task<ActionResult> UpsertCost([FromBody] CostUpsertRequest req, CancellationToken ct)
    {
        ...
        cmd.Parameters.AddWithValue("p", NpgsqlTypes.NpgsqlDbType.Text, req.Provider.ToLowerInvariant().Trim());
        cmd.Parameters.AddWithValue("m", NpgsqlTypes.NpgsqlDbType.Text, req.Model.ToLowerInvariant().Trim());
        cmd.Parameters.AddWithValue("in1k", NpgsqlTypes.NpgsqlDbType.Numeric, req.InputPer1K);
        cmd.Parameters.AddWithValue("out1k", NpgsqlTypes.NpgsqlDbType.Numeric, req.OutputPer1K);
        cmd.Parameters.AddWithValue("emb1k", NpgsqlTypes.NpgsqlDbType.Numeric, req.EmbPer1KTokens);
    ...
    public async Task<ActionResult> DeleteCost(string provider, string model, CancellationToken ct)
    {
        ...
        cmd.Parameters.AddWithValue("p", NpgsqlTypes.NpgsqlDbType.Text, provider.ToLowerInvariant().Trim());
        cmd.Parameters.AddWithValue("m", NpgsqlTypes.NpgsqlDbType.Text, model.ToLowerInvariant().Trim());
